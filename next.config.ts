  ...
  async headers() {
    ...
    if (isProduction) {
      securityHeaders.push({
        ...
        value: [
          "default-src 'self'",
          "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://sdk.mercadopago.com https://*.hotjar.com",
          "style-src 'self' 'unsafe-inline'",
          "img-src 'self' data: https: https://*.hotjar.com",
          "font-src 'self'",
          "connect-src 'self' https://*.vercel.app https://*.railway.app https://www.google-analytics.com https://*.googletagmanager.com https://api.linkepag.com.br https://api.mercadopago.com https://www.mercadolibre.com https://api.mercadolibre.com https://*.hotjar.com https://*.hotjar.io",
          "frame-src 'self' https://www.mercadolibre.com https://*.mercadopago.com",
