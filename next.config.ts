    ...
    if (isProduction) {
      securityHeaders.push({
        ...
        value: [
          ...
          "font-src 'self'",
          "connect-src 'self' https://*.vercel.app https://*.railway.app https://www.google-analytics.com https://*.googletagmanager.com https://api.linkepag.com.br https://api.mercadopago.com https://www.mercadolibre.com https://api.mercadolibre.com",
