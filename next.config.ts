  ...
  async headers() {
    ...
    if (isProduction) {
      securityHeaders.push({
        ...
        value: [
          "default-src 'self'",
          "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://sdk.mercadopago.com https://*.hotjar.com https://connect.facebook.net https://*.facebook.com https://analytics.tiktok.com https://*.tiktok.com",
