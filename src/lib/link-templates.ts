...
export const linkTemplates: LinkTemplateConfig[] = [
  {
    ...
    shortDesc: 'Libere acesso a grupos VIP, links, etc. ',
    icon: IconLock,
    color: 'indigo',
  },
  {
    ...
    shortDesc: 'Entregue de forma segura seus ebooks, planilhas, etc',
    icon: IconDownload,
    color: 'amber',
  },
  {
    id: 'direct',
    label: 'Link comum',
    shortDesc: 'Redirecione para suas redes sociais, sites, etc',
    icon: IconLink,
    color: 'emerald',
  },
  {
    ...
    shortDesc: 'Adicione seu contato do WhatsApp, Telegram etc.',
    icon: IconCalendar,
    color: 'violet',
  },
];
