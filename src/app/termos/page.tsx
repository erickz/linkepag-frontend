...
export default function TermosPage() {
  return (
    <main className="min-h-screen bg-slate-950">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-900 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/#pricing" className="text-sm text-slate-200 hover:text-white transition">
              Planos
            </Link>
            <Link href="/contato" className="text-sm text-slate-200 hover:text-white transition">
              Contato
            </Link>
          </nav>
